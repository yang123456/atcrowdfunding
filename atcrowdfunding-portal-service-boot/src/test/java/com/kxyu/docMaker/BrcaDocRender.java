...
import com.kxyu.docMaker.Brca.BrcaTableList;
...
public class BrcaDocRender {
    ...
    public static void bindDatas(BrcaCmdOption cmdOption) throws IOException {
       ...
       // File file = new File("C:\\Users\\yuki_cool\\yukaixin\\docrender\\src\\main\\resources\\test.txt");
        ...
        Map<String, Object> datas = new HashMap<String, Object>(){{
            ...
            put(PATIENT_AGE_KEY, "");
            put(PATIENT_SEX_KEY, "");
            put(BRCA_REPORT_CHINSES_DATE, DateUtil.chineseFormatDate(date));
            put(BRCA_REPORT_DATE, DateUtil.format(date, DateUtil.FORMATTER_OF_DATE));
            ...
            put(BRCA_REPORT_TABLE, new TableRenderData(new ArrayList<RenderData>(){{
                add(new TextRenderData(BRCA_TABLE_HEAD_WHITE_COLOR, BRCA_TABLE_GENE));
                add(new TextRenderData(BRCA_TABLE_HEAD_WHITE_COLOR, BRCA_TABLE_MUTION));
                add(new TextRenderData(BRCA_TABLE_HEAD_WHITE_COLOR, BRCA_TABLE_GENOTYPE));
                add(new TextRenderData(BRCA_TABLE_HEAD_WHITE_COLOR, BRCA_TABLE_DBSNP));
                add(new TextRenderData(BRCA_TABLE_HEAD_WHITE_COLOR, BRCA_TABLE_CLINSIG));
        ...
        //doc.registerPolicy(" ", new MyTableRenderPolicy());
