...
<title>图片裁剪上传</title>
<%-- <link rel="stylesheet" href="<c:url value="/resources/jcrop/css/jquery.Jcrop.css"/>"  />
...
<link rel="stylesheet" type="text/css" href="${APP_PATH}/jcrop/css/jquery.Jcrop.css" />
<script  type="text/javascript" src="${APP_PATH}/jcrop/js/jquery.min.js" /></script>
<script  type="text/javascript" src="${APP_PATH}/jcrop/js/jquery.Jcrop.js" /></script>


</head>
<body>
	<form name="form" action="<%=request.getContextPath()%>/upload/uploadHeadImage" class="form-horizontal" method="post" enctype="multipart/form-data">
