...
<%-- 	<center>
	...
	<hr/>
	<center>
		<form action="advertisement/onefile2" method="post"
			enctype="multipart/form-data">
			<input type="file" name="file" /> <input type="submit" value="上 传" />
		</form>
		<h5>上传结果：</h5>
		<img alt="暂无图片" src="${fileUrl2}" />
	</center>
	<hr/>
	<center>
		<form action="advertisement/threeFile" method="post"
			enctype="multipart/form-data">
...
function initFileInput() {
    $("#uploadImg").fileinput({
        ...
        uploadUrl: "advertisement/onefile", //上传的地址
