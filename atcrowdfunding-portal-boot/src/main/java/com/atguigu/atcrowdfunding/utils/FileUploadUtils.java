...
import com.atguigu.atcrowdfunding.exception.FileNameLengthLimitExceededException;
import com.atguigu.atcrowdfunding.exception.InvalidExtensionException;
import com.atguigu.atcrowdfunding.utils.security.Coder;
...
public class FileUploadUtils {
	private static Logger logger = LoggerFactory.getLogger(FileUploadUtils.class.getClass());
	// 默认大小 50M
	...
	/**
	 * 编码文件名,默认格式为： 1、'_'替换为 ' ' 2、hex(md5(filename + now nano time + counter++))
	 * 3、[2]_原始文件名
	 *
	 * @param filename
	 * @return
