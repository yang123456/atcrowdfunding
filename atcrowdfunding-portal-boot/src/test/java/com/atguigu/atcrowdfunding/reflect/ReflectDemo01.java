package com.atguigu.atcrowdfunding.reflect;
...
public class ReflectDemo01 {
	...
	public static void demo01() {
		...
		//1 Class.forName("全类名")
		try {
			Class<?> perClazz =  Class.forName("com.atguigu.atcrowdfunding.reflect.Person") ;
...
//		 3 对象.getClass()
	...
	public static void demo02() {
		...
		Class<?> perClazz =  null ; 
		try {
			perClazz =  Class.forName("com.atguigu.atcrowdfunding.reflect.Person") ;
		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}
