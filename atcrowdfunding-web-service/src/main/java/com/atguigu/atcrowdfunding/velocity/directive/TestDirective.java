...
//        Object data = sn.value(context);
    ...
    public static String renderTemplate(Map params, String vimStr) throws ParseErrorException, MethodInvocationException, ResourceNotFoundException, IOException {
